...
def test_rescan_does_not_duplicate_video(db, monkeypatch):
    ...
    class FakeClient:
        ...
        def list_uploads(self, _):
            yield {"youtube_video_id":"video-1", "title":"Video một", "url":"https://youtube.com/watch?v=video-1", "published_at":datetime(2025,1,1), "duration_seconds":100, "thumbnail_url":None, "video_type":"video"}
