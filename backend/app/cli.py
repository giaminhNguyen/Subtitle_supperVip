...
from .services.runtime_settings import set_youtube_api_key


def main() -> None:
    parser = argparse.ArgumentParser(description="YouTube Subtitle Manager")
    subcommands = parser.add_subparsers(dest="command", required=True)
    set_key = subcommands.add_parser("set-youtube-api-key", help="Lưu YouTube Data API key vào database dùng chung")
    ...
    if arguments.command == "set-youtube-api-key":
        ...
        print("Đã lưu YouTube API key vào database.")
